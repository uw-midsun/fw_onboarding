 ...
 *
 * @date   2025-08-23
 * @author Sam Shrivastava - Midnight Sun Team #24 - MSXVI
 ************************************************************************************************/
...
TASK(ads1115_writer, TASK_STACK_256) {
  ...
  while(true) {
    ...
    if(queue_send(&ads1115_data_queue, &voltage, ADS1115_SAMPLING_PERIOD_MS) != STATUS_CODE_OK) {
